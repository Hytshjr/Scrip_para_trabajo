...
# name = 'test_image/SUPERFAZIL__TTFOOD__GASEOSA_+_PH__5_AL_11_JUN_MAIL.zip'

# from image_cut import descomprimir

# print(descomprimir(name))
import fileinput
import glob
import os

archivos = os.listdir('/home/hytsh/Documentos/App_fazil/test_image')
print(archivos)